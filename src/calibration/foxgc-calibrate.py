...
square_option = ttk.Combobox(root, width=14, textvariable=selected_square, values=['A19', 'T19', 'A1', 'T1'], state='readonly')
square_option.grid(row=0, column=0, sticky='ew')
offset_x_entry = ttk.Entry(root, width=16)
offset_x_entry.grid(row=0, column=1, sticky='ew')
offset_x_entry.insert(0, str(offset_x))
offset_y_entry = ttk.Entry(root, width=16)
